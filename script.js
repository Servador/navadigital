...
const PRODUCTS = [
  ...
  { id:"netflix",     
    ...
    packages:[{id:"nflx-1p", title:"Sharing 1P2U 1 Bulan", desc:"Note: akun sharing 1 profil diisi 2 user bisa limit", price:15000},
              {id:"nflx-2p", title:"Sharing 1P1U 1 Bulan", desc:"Note: akun sharing 1 profil diisi 1 user bisa limit", price:22000},
              {id:"nflx-3p", title:"Netflix Semi Private", desc:"Note: Jatah 1 profile boleh login 2 device (hp/tv) - bebas ubah nama/foto profile - garansi anti limit", price:27000},
  ...
  { id:"youtube",     
    ...
    from:2000,    cat:"Video", kind:"subscription", 
    desc:"Tanpa iklan + YouTube Music.",
    img:"assets/yt.png",
    packages:[{id:"yt1", title:"Invite 1 Bulan", desc:"Note: Full Garansi, Akun Buyyer", price:2000},
              {id:"yt2", title:"Famhed 1 Bulan", desc:"Note: Bisa Invite 5 Orang, Full Garansi, Akun Seller", price:8000},
    ] }, 
  { id:"canva",       
    name:"Canva Pro",               
    from:500,    cat:"Design", kind:"subscription", 
    desc:"Desain profesional & kolaborasi.",
    img:"assets/canva.jpg",
    packages:[{ id:"cv1", title:"Member 1 Bulan", desc:"Note : Member + Free Designer", price:500},
              { id:"cv2", title:"Member 1 Tahun", desc:"Note : Member + Free Designer", price:5000},
              { id:"cv3", title:"Admin 1 Bulan", desc:"Note : Bisa Invite 20 Member", price:8000},
  ...
  { id:"vidio",       
    ...
    packages:[{id:"vd3", title:"Private (TV Only) 1 Tahun", desc:"Note : TV Only ! , Garansi only back free 1 bulan", price:10000},
              {id:"vd1", title:"Sharing 1 Bulan", desc:"Note : All Device, Full Garansi", price:22000},
              {id:"vd2", title:"Private 1 Bulan", desc:"Note : All Device, Full Garansi", price:38000},
    ] },
  { id:"wetv",        
    name:"WeTV",                    
    from:10000,   cat:"Video", kind:"subscription", 
  ...
  { id:"scribd",      
    ...
    packages:[{id:"scb1", title:"Sharing 1 Bulan", desc:"Note : Akun Trial (Premium) Full Garansi", price:5000},
              {id:"scb2", title:"Private 1 Bulan", desc:"Note : Akun Trial (Premium) Full Garansi", price:8000},
] },
];
